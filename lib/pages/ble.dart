...
//   var BLECon = getIt<BleConnection>();
//   BLECon.deviceId = device.deviceId;  
...
//     BleConnectionProvider = BleConnection(device.deviceId);

//     // Attempt to connect (with optional timeout)
//     await BleConnectionProvider?.connect().timeout(
...
//   try {
//     if (BleConnectionProvider == null || !(BleConnectionProvider?.isConnected ?? false)) {
//       print('No active connection to disconnect.');
//       return;
//     }
//     await BleConnectionProvider?.close();
//   } finally {
